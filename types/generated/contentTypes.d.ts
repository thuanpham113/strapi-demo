...
export interface ApiDisplay3DDisplay3D extends Schema.CollectionType {
  ...
  info: {
    singularName: 'display3-d';
    pluralName: 'display3-ds';
...
export interface ApiLocateLocate extends Schema.CollectionType {
  collectionName: 'locates';
  info: {
    singularName: 'locate';
    pluralName: 'locates';
    displayName: 'Locate';
  ...
  attributes: {
    ...
    satsFixed: Attribute.Float;
    signalStrength: Attribute.Float;
    action: Attribute.Boolean;
    sms: Attribute.RichText;
    tel: Attribute.String & Attribute.Required;
    bat: Attribute.Decimal;
    idMachine: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::locate.locate',
...
export interface ApiMachineMachine extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    tel: Attribute.String & Attribute.Required & Attribute.Unique;
    address: Attribute.Text;
    timeOut: Attribute.String;
    status: Attribute.String;
    notion: Attribute.RichText;
